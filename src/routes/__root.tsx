...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Klassiq Grafikz Studios" },
      { name: "description", content: "Creative agency — we design, edit, brand, animate and advertise." },
      { name: "author", content: "Klassiq Grafikz" },
      { property: "og:title", content: "Klassiq Grafikz Studios" },
      { property: "og:description", content: "Creative agency — we design, edit, brand, animate and advertise." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Sora:wght@300;400;500;600;700;800&family=Manrope:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500&display=swap",
      },
